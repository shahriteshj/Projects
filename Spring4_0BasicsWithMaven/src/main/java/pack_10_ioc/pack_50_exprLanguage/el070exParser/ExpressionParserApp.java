package pack_10_ioc.pack_50_exprLanguage.el070exParser;
...
public class ExpressionParserApp {
	public static void main(String[] args) {
		...
		StandardEvaluationContext testContext = new StandardEvaluationContext(operands);
		...
		Expression exp5 = parser.parseExpression("email == 'Hello@javacodegeeks.com'"); // 'cbdesh2000@yahoo.com'
